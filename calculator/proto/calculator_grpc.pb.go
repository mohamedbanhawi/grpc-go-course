...
func (c *calculateServiceClient) Primes(ctx context.Context, in *PrimesRequest, opts ...grpc.CallOption) (CalculateService_PrimesClient, error) {
	stream, err := c.cc.NewStream(ctx, &CalculateService_ServiceDesc.Streams[0], "/calculator.CalculateService/Primes", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *calculateServiceClient) Average(ctx context.Context, opts ...grpc.CallOption) (CalculateService_AverageClient, error) {
	stream, err := c.cc.NewStream(ctx, &CalculateService_ServiceDesc.Streams[1], "/calculator.CalculateService/Average", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *calculateServiceClient) Max(ctx context.Context, opts ...grpc.CallOption) (CalculateService_MaxClient, error) {
	stream, err := c.cc.NewStream(ctx, &CalculateService_ServiceDesc.Streams[2], "/calculator.CalculateService/Max", opts...)
	if err != nil {
		return nil, err
	}
	x := &calculateServiceMaxClient{stream}
	return x, nil
}
...
type calculateServiceMaxClient struct {
	grpc.ClientStream
}

func (x *calculateServiceMaxClient) Send(m *MaxRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *calculateServiceMaxClient) Recv() (*MaxResponse, error) {
	m := new(MaxResponse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func (c *calculateServiceClient) Sqrt(ctx context.Context, in *SqrtRequest, opts ...grpc.CallOption) (*SqrtResponse, error) {
	out := new(SqrtResponse)
	err := c.cc.Invoke(ctx, "/calculator.CalculateService/Sqrt", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _CalculateService_Max_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(CalculateServiceServer).Max(&calculateServiceMaxServer{stream})
}
...
type calculateServiceMaxServer struct {
	grpc.ServerStream
}

func (x *calculateServiceMaxServer) Send(m *MaxResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *calculateServiceMaxServer) Recv() (*MaxRequest, error) {
	m := new(MaxRequest)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func _CalculateService_Sqrt_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SqrtRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CalculateServiceServer).Sqrt(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/calculator.CalculateService/Sqrt",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CalculateServiceServer).Sqrt(ctx, req.(*SqrtRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var CalculateService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "Sqrt",
			Handler:    _CalculateService_Sqrt_Handler,
		},
	},
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "Max",
			Handler:       _CalculateService_Max_Handler,
			ServerStreams: true,
			ClientStreams: true,
		},
	},
